...
<head>
    ...
    <meta name="description" content="SecureSubmit C# Web Forms end-to-end payment example using tokenization.">
...
<body>
    <div class="container">
        <h1>Web Forms Example App</h1>
        <br />
        <form id="payment_form" action="Default.aspx">
            <div class="row">
                <div class="col-md-6">
                    <fieldset>
