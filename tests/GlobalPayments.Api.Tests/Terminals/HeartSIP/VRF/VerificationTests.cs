...
namespace GlobalPayments.Api.Tests.Terminals.HeartSIP.VRF {
    [TestClass]
    public class HsipVerificationTests {
        ...
        */
        ...
        public void TestCase01() {
            var response = _device.CreditSale(1, 23m)
        ...
        */
        ...
        public void TestCase03() {
            var response = _device.CreditSale(2, 25m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);
        ...
        */
        ...
        public void TestCase04() {
            ...
            var response = _device.CreditSale(2, 90.08m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);
        ...
        */
        ...
        public void TestCase05() {
            var response = _device.CreditSale(2, 155m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
        ...
        */
        ...
        public void TestCase06() {
            var response = _device.CreditSale(2, 10m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);

            var voidResponse = _device.CreditVoid(2)
        ...
        */
        ...
        public void TestCase09() {
            var response = _device.CreditRefund(1, 9m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);
        ...
        */
        ...
        public void TestCase10b() {
            var response = _device.GiftAddValue(1)
                .WithAmount(8m)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);
        ...
        public void TestCase10c() {
            var response = _device.GiftSale(1, 1m)
                .WithAllowDuplicates(true)
                .Execute();
            Assert.IsNotNull(response);
            Assert.AreEqual("00", response.ResponseCode);
