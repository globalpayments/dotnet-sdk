...
namespace GlobalPayments.Api.Gateways.BillPay {
    internal sealed class MakeBlindPaymentRequest : BillPayRequestBase {
        public MakeBlindPaymentRequest(ElementTree et) : base(et) { }
        ...
        public string Build(Element envelope, AuthorizationBuilder builder, Credentials credentials) {
            ...
            var methodElement = et.SubElement(body, "bil:MakeBlindPayment");
            var requestElement = et.SubElement(methodElement, "bil:MakeE3PaymentRequest");
