...
namespace GlobalPayments.Api.Gateways.BillPay {
    internal sealed class MakeQuickPayBlindPaymentRequest : BillPayRequestBase {
        public MakeQuickPayBlindPaymentRequest(ElementTree et) : base(et) { }
        ...
        public string Build(Element envelope, AuthorizationBuilder builder, Credentials credentials)
        {
            ...
            var methodElement = et.SubElement(body, "bil:MakeQuickPayBlindPayment");
