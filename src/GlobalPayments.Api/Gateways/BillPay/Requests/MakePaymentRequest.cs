...
namespace GlobalPayments.Api.Gateways.BillPay {
    internal sealed class MakePaymentRequest : BillPayRequestBase {
        public MakePaymentRequest(ElementTree et) : base(et) { }
        ...
        public string Build(Element envelope, AuthorizationBuilder builder, Credentials credentials) {
            ...
            var methodElement = et.SubElement(body, "bil:MakePayment");
